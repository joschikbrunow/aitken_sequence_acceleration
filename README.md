...
$$
\hat{A}_m \coloneq A_m-\frac{(\delta A_m)^2}{\delta^2A_m}
$$
with
$$
\delta A_m\coloneq A_{m+1}-A_m,\quad\delta^2A_m\coloneq\delta(\delta A_m)
$$
...
6. Visualize the convergence interactively:
   ...
   slides = [
       ...
       #   Any other input (like -1) disables normal Aitken
